...
@interface XSThreadCountDownManager : NSObject
@property (nonatomic, strong)__block dispatch_queue_t        mQueue;
@property (nonatomic, strong)__block dispatch_source_t       mTimer;
