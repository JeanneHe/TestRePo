...
+ (NSString *)createPointStringToString:(NSString *)string
{
    ...
    [inputFormatter setDateFormat:@"YYYY-MM-dd HH:ss:mm"];
    NSDate* inputDate = [inputFormatter dateFromString:string];
    NSDateFormatter *outputFormatter = [[NSDateFormatter alloc] init];
    [outputFormatter setDateFormat:@"yyyy.MM.dd"];
    NSString *outPutstr = [outputFormatter stringFromDate:inputDate];
...
+ (NSString *)createYhStringToString:(NSString *)string
{
    ...
    NSDate* inputDate = [inputFormatter dateFromString:string];
    NSDateFormatter *outputFormatter = [[NSDateFormatter alloc] init];
    [outputFormatter setDateFormat:@"yyyy.MM.dd HH:ss"];
    NSString *outPutstr = [outputFormatter stringFromDate:inputDate];
